...
-- Create tables
CREATE TABLE Category(ID INT PRIMARY KEY IDENTITY, Name TEXT);
...
CREATE TABLE Product(ID INT PRIMARY KEY IDENTITY, Name TEXT, Price INT, CatID INT, FOREIGN KEY (CatID) REFERENCES Category(ID) ON DELETE CASCADE);
